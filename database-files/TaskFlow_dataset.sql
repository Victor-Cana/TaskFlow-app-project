...
INSERT INTO Users(userID,email1,email2,email3,firstName,lastName) VALUES
 (1,'rwannell0@odnoklassniki.ru','rwannell0@livejournal.com',NULL,'Rodrique','Wannell')
,(2,'twinskill1@e-recht24.de',NULL,NULL,'Trev','Winskill')
,(3,'rspurrier2@virginia.edu',NULL,NULL,'Rivi','Spurrier')
,(4,'nsantino3@moonfruit.com',NULL,NULL,'Nanny','Santino')
,(5,'dpleming4@paypal.com',NULL,NULL,'Dorelle','Pleming')
,(6,'akears5@independent.co.uk',NULL,NULL,'Adrian','Kears')
,(7,'cmalter6@guardian.co.uk',NULL,NULL,'Cassie','Malter')
,(8,'ttrever7@1und1.de','ttrever7@ehow.com',NULL,'Theresa','Trever')
,(9,'mgander8@parallels.com','mgander8@domainmarket.com',NULL,'Maurine','Gander')
,(10,'skarpman9@goo.gl',NULL,NULL,'Sibley','Karpman')
,(11,'tbentincka@live.com',NULL,NULL,'Taber','Bentinck')
,(12,'hgiovanninib@princeton.edu',NULL,NULL,'Herculie','Giovannini')
,(13,'ljennoc@issuu.com','ljennoc@ca.gov',NULL,'Lazaro','Jenno')
,(14,'ncantopherd@addthis.com',NULL,NULL,'Nicolis','Cantopher')
,(15,'mbhatiae@github.io','mbhatiae@ed.gov',NULL,'Melody','Bhatia')
,(16,'nmillyardf@macromedia.com','nmillyardf@yale.edu',NULL,'Niall','Millyard')
,(17,'faindriug@princeton.edu',NULL,NULL,'Frans','Aindriu')
,(18,'cdrabbleh@paypal.com','cdrabbleh@mapquest.com',NULL,'Carmella','Drabble')
,(19,'fmargettsi@hp.com',NULL,NULL,'Fayina','Margetts')
,(20,'nveelerj@army.mil','nveelerj@cam.ac.uk',NULL,'Normand','Veeler')
,(21,'wfiltnessk@blogspot.com','wfiltnessk@behance.net',NULL,'Wendi','Filtness')
,(22,'rdrakel@apache.org','rdrakel@nih.gov',NULL,'Roberta','Drake')
,(23,'edriversm@independent.co.uk',NULL,NULL,'Enrique','Drivers')
,(24,'nbrechn@goo.ne.jp','nbrechn@umich.edu',NULL,'Nealon','Brech')
,(25,'lscudamoreo@va.gov',NULL,NULL,'Leyla','Scudamore')
,(26,'dbaumanp@umn.edu','dbaumanp@slideshare.net',NULL,'Dorie','Bauman')
,(27,'mgilbaneq@ezinearticles.com','mgilbaneq@topsy.com',NULL,'Mycah','Gilbane')
,(28,'tclausenr@i2i.jp','tclausenr@businessinsider.com',NULL,'Theodore','Clausen')
,(29,'ftunes@wufoo.com','ftunes@domainmarket.com',NULL,'Fanni','Tune')
,(30,'nbarsbyt@yahoo.co.jp','nbarsbyt@newyorker.com',NULL,'Nicolais','Barsby')
,(31,'mpooleyu@examiner.com','mpooleyu@yandex.ru',NULL,'Moss','Pooley')
,(32,'dgounodv@bluehost.com','dgounodv@ebay.co.uk',NULL,'Devon','Gounod')
,(33,'achristonw@photobucket.com',NULL,NULL,'Ase','Christon')
,(34,'fhallgarthx@vistaprint.com',NULL,NULL,'Faun','Hallgarth')
,(35,'udiviney@guardian.co.uk',NULL,NULL,'Ulrick','Divine');
...
INSERT INTO Resources(resourceID,name,type,description,link,dateDue) VALUES
 (1,'fusce','.docx',NULL,'https:///orci.html?fusce=lorem&posuere=id&felis=ligula&sed=suspendisse&lacus=ornare&morbi=consequat&','2026-04-15')
,(2,'velit','.docx',NULL,'https:///arcu/adipiscing/molestie/hendrerit/at.jpg?quam=sapien&nec=sapien&dui=non&luctus=mi&rutrum=i','2025-09-10')
,(3,'at','.docx',NULL,'https:///justo/morbi/ut/odio.jpg?justo=malesuada&lacinia=in&eget=imperdiet&tincidunt=et&eget=commodo','2025-03-23')
,(4,'dolor','.xlsx',NULL,'http:///in.png?tempus=a&sit=odio&amet=in&sem=hac','2026-08-20')
,(5,'consequat','.pdf',NULL,'http:///gravida/sem/praesent.jpg?orci=dui&eget=luctus&orci=rutrum&vehicula=nulla&condimentum=tellus&','2025-04-03')
,(6,'dictumst','.csv',NULL,'https:///nam/ultrices/libero/non.xml?et=donec&eros=ut&vestibulum=dolor&ac=morbi&est=vel&lacinia=lect','2025-05-18')
,(7,'massa id','.docx',NULL,'http:///purus/eu/magna/vulputate/luctus/cum/sociis.json?mi=sed&in=magna&porttitor=at&pede=nunc&justo','2025-08-28')
,(8,'elementum pellentesque','.docx','Curabitur gravida nisi at nibh.','http:///congue/risus/semper/porta/volutpat.json?nulla=dapibus&sed=dolor&vel=vel&enim=est&sit=donec&a',NULL)
,(9,'dapibus','.xlsx',NULL,'http:///ante/ipsum/primis.jsp?nisi=odio&nam=donec&ultrices=vitae&libero=nisi&non=nam&mattis=ultrices','2026-09-12')
,(10,'potenti in','.pdf','Nullam molestie nibh in lectus.','https:///fusce/congue/diam.png?mauris=primis&morbi=in&non=faucibus&lectus=orci&aliquam=luctus&sit=et','2026-04-19')
,(11,'justo','.csv','Praesent id massa id nisl venenatis lacinia.','https:///vehicula/condimentum.jsp?nec=sapien&dui=urna&luctus=pretium&rutrum=nisl&nulla=ut&tellus=vol','2025-07-02')
,(12,'neque','.xlsx','Sed ante.','http:///dolor/morbi/vel/lectus.js?felis=luctus&donec=et&semper=ultrices&sapien=posuere&a=cubilia','2025-03-18')
,(13,'vestibulum','.pdf',NULL,'http:///cras/in/purus/eu/magna/vulputate.png?felis=faucibus&eu=orci&sapien=luctus&cursus=et&vestibul','2025-01-20')
,(14,'mattis nibh','.pdf',NULL,'http:///sit/amet/lobortis.jpg?sed=nibh&augue=fusce&aliquam=lacus&erat=purus&volutpat=aliquet&in=at&c','2025-08-12')
,(15,'in','.docx',NULL,'http:///quis/lectus/suspendisse/potenti/in/eleifend/quam.png?posuere=tincidunt&felis=lacus&sed=at&la','2025-02-07')
,(16,'nullam orci','.csv',NULL,'https:///amet.json?curae=convallis&donec=duis&pharetra=consequat&magna=dui&vestibulum=nec&aliquet=ni','2025-12-16')
,(17,'ultrices posuere','.docx','Nunc purus.','http:///purus.json?felis=felis&donec=ut&semper=at&sapien=dolor&a=quis&libero=odio&nam=consequat&dui=','2024-12-13')
,(18,'nibh fusce','.pdf',NULL,'http:///donec.jsp?sed=vestibulum&nisl=ante&nunc=ipsum&rhoncus=primis&dui=in&vel=faucibus&sem=orci&se','2026-03-05')
,(19,'adipiscing elit','.docx','Donec ut dolor.','http:///libero/nullam/sit/amet/turpis/elementum/ligula.html?vulputate=nisl&luctus=aenean&cum=lectus&','2025-11-28')
,(20,'nulla','.docx',NULL,'http:///et.json?pretium=montes&iaculis=nascetur&justo=ridiculus&in=mus&hac=vivamus&habitasse=vestibu',NULL)
,(21,'nibh','.pdf','Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh.','https:///turpis/nec/euismod.jpg?et=posuere&commodo=metus&vulputate=vitae&justo=ipsum&in=aliquam&blan','2025-12-26')
,(22,'sollicitudin ut','.pdf','Lorem ipsum dolor sit amet, consectetuer adipiscing elit.','https:///dolor/morbi/vel.json?libero=quam&convallis=sollicitudin&eget=vitae&eleifend=consectetuer&lu','2025-05-26')
,(23,'rhoncus sed','.csv',NULL,'http:///enim.js?sit=fringilla&amet=rhoncus&lobortis=mauris&sapien=enim&sapien=leo&non=rhoncus&mi=sed','2025-06-20')
,(24,'ligula','.pdf','Cras in purus eu magna vulputate luctus.','http:///faucibus/orci.json?ipsum=imperdiet&integer=et&a=commodo&nibh=vulputate&in=justo&quis=in&just','2026-06-04')
,(25,'ipsum','.pdf',NULL,'https:///id/luctus/nec/molestie/sed/justo/pellentesque.json?iaculis=platea&justo=dictumst&in=maecena','2025-10-07')
,(26,'tellus nulla','.pdf',NULL,'https:///eget/eleifend/luctus/ultricies/eu.xml?eu=non&massa=mi&donec=integer&dapibus=ac&duis=neque&a','2026-11-17')
,(27,'sit amet','.xlsx',NULL,'http:///fermentum/donec/ut/mauris/eget/massa.png?morbi=rhoncus&quis=sed&tortor=vestibulum&id=sit&nul','2026-02-26')
,(28,'non quam','.docx',NULL,'http:///at.jsp?eu=eu','2026-05-06')
,(29,'sit','.xlsx',NULL,'https:///sociis/natoque/penatibus/et.html?libero=morbi&nullam=porttitor&sit=lorem&amet=id&turpis=lig','2026-01-10')
,(30,'magnis','.csv',NULL,'http:///non/quam/nec/dui/luctus/rutrum/nulla.json?etiam=habitasse&pretium=platea&iaculis=dictumst&ju','2026-09-28')
,(31,'nulla tempus','.pdf',NULL,'https:///sit.xml?sociis=consequat&natoque=nulla&penatibus=nisl&et=nunc&magnis=nisl&dis=duis&parturie','2025-01-29')
,(32,'cras','.docx',NULL,'http:///nunc.js?aliquet=nulla&at=suscipit&feugiat=ligula&non=in&pretium=lacus&quis=curabitur&lectus=','2025-11-20')
,(33,'vestibulum sit','.xlsx',NULL,'http:///posuere/felis/sed.jsp?dapibus=eu&duis=tincidunt&at=in&velit=leo&eu=maecenas&est=pulvinar&con','2025-10-09')
,(34,'orci','.pdf','Integer ac neque.','https:///id/sapien.xml?amet=felis&eleifend=eu&pede=sapien&libero=cursus&quis=vestibulum&orci=proin&n','2026-01-05')
,(35,'adipiscing','.xlsx',NULL,'http:///leo/pellentesque/ultrices.jsp?id=massa&justo=tempor&sit=convallis&amet=nulla&sapien=neque&di','2025-07-10');
